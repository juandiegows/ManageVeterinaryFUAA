        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('manage-pets') }}" :active="request()->routeIs('manage-pets')">
                        {{ __('Administrar Mascota') }}
                    </x-nav-link>

                    <x-nav-link href="{{ route('manage-vaccines') }}" :active="request()->routeIs('manage-vaccines')">
